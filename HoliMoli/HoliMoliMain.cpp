    ...
    m_locatabilityChangedToken =
        m_locator->LocatabilityChanged +=
            ref new Windows::Foundation::TypedEventHandler<SpatialLocator^, Object^>(
                std::bind(&HoliMoliMain::OnLocatabilityChanged, this, _1, _2)
                );
    ...
    m_cameraAddedToken =
        m_holographicSpace->CameraAdded +=
            ref new Windows::Foundation::TypedEventHandler<HolographicSpace^, HolographicSpaceCameraAddedEventArgs^>(
                std::bind(&HoliMoliMain::OnCameraAdded, this, _1, _2)
                );
    ...
    m_cameraRemovedToken =
        m_holographicSpace->CameraRemoved +=
            ref new Windows::Foundation::TypedEventHandler<HolographicSpace^, HolographicSpaceCameraRemovedEventArgs^>(
                std::bind(&HoliMoliMain::OnCameraRemoved, this, _1, _2)
                );
    ...
    SpeechContinuousRecognitionResultGeneratedEventArgs^ args)
{
    if (args->Result->RawConfidence > 0.5f)
    {
        ...
        else if (args->Result->Text == L"reset")
        {
            m_spinningMoleculeRenderer->SetDefaultScaling();
            m_spinningMoleculeRenderer->SetDefaultDistance();
            m_spinningMoleculeRenderer->SetDefaultRotationSpeed();
            m_repositionMolecule = true;
        }
...
HolographicFrame^ HoliMoliMain::Update()
{
...
bool HoliMoliMain::Render(Windows::Graphics::Holographic::HolographicFrame^ holographicFrame)
{
...
void HoliMoliMain::SaveAppState()
{
    //
...
void HoliMoliMain::LoadAppState()
{
    //
...
void HoliMoliMain::OnCameraAdded(
...
void HoliMoliMain::OnCameraRemoved(
    HolographicSpace^ sender,
